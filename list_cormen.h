...
void rm(struct vertex_list* vlist, struct vertex* vertex,
                    struct vertex_list_node* node, size_t num_of_node)
{
	vertex_list_rm((vlist+num_of_node*sizeof(struct vertex_list*)), 
		       vertex, node);
}
